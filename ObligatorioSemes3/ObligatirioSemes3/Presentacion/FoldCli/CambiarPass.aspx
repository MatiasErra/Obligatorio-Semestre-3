<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiarPass.aspx.cs" Inherits="ObligatirioSemes3.Presentacion.FoldCli.CambiarPass" %>
...
<body>
    ...
    <p>
        &nbsp; </p>
    <p/>
        <asp:Button ID="btnAlta" runat="server" OnClick="btnAlta_Click" Text="Cambiar Contraseña" Height="24px" />
